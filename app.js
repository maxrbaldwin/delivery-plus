    ...
    .get(function(req, resf){
        ...
        request(options, function(err, res, loc){
            ...
            request(mechOpts, function(err, resp, merch){
                ...
                var newJson = {latitude : lat, longitude : longt, resturants : [gotMerch] };
                console.log(newJson);
                resf.send(newJson);
...
app.route('/menu/:id')
    .get(function(req, res){
        ...
        var url = 'http://sandbox.delivery.com/merchant/' + id + '/menu';
...
app.route('suggest/:dis/:cus')
    .get(function(req, res){
        var dis = req.params.dis;
        var cus = req.params.cus;
        var url = 'http://sandbox.delivery.com/merchant/search/delivery?' + lat + '&' + longt;
